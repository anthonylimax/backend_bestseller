...
export const setRoutes = (routes: Router) => {
    ...
    routes.get('/searchRakutenItems', async (request: Request, response: Response) => {
        try {
            const { applicationId="1050682487455494185", keyword="楽天", genreId="555086", sort, minPrice, maxPrice, hits, page } = request.body;
